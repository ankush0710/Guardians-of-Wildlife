  ...
  return (
    <>
      <footer className="bg-[#111F35] max-w-screen flex flex-col justify-center gap-10 py-18">
        ...
        <div id="container" className="flex justify-around px-2 flex-1">
        ...
        <div
          id="message-form"
          className="bg-[#213C51] rounded-xl flex flex-col pt-10 pb-15 px-10 mx-6 mt-10 relative md:w-96 lg:w-2xl"
        >
          <form action="">
            ...
            <div className="flex items-start mb-4 mt-3">
              ...
              >
                By submitting this form, I agree to the collection and use my personla dataas per the privacy Policy for marketing purpose.
              </label>
            </div>

             {/* form submitt button  */}
            <div className="absolute right-0 px-10">
              <button type="button" className="text-white font-body bg-transparent border-2 border-[#111F35] px-8 py-2 rounded-full hover:bg-[#111F35] hover:border-2 hover:border-[#6594B1] hover:duration-600">Submit</button>
            </div>
          </form>
        </div>
        </div>
