    ...
    <>
      <footer className="bg-[#111F35] min-w-screen flex flex-col justify-center gap-10 py-18">
        ...
        <div id="terms_condition">
          <p className="font-body text-white text-sm text-center py-4">
          ...
          <div className="flex gap-3 justify-center font-body text-white font-sm">
            <p className="font-body"><a href="#">Terms & Conditions</a></p>
            <p className="font-body"><a href="#">Privacy Policy</a></p>
          </div>
        </div>
      </footer>
    </>
