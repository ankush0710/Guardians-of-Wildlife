...
const ProgramCard = () => {
  return (
    <>
    <div id="program-card" className="relative h-auto mx-5 rounded-xl flex flex-col gap-5 items-center bg-cover bg-center md:bg-none" style={{backgroundImage: `url(${sample})`}}>
        {/* <div id="card-image" className="relative w-78 h-78 border border-gray-500 mt-10 ">
          <img src={sample} alt="image" className="w-full h-full object-contain"/>
        </div> */}
        <div className="absolute inset-0 bg-black opacity-25"></div>
        
        <div id="description" className="relative px-5 py-10">
          <p className="font-body text-white">
            <span className="font-heading  text-xl font-bold space-x-2">Description:- </span>Project Tiger was launched in 1973 with the aim of conserving Bengal
