...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <h1 className="my-10 text-5xl font-heading text-center font-bold text-gray-500">
      ...
      <h1 className="mt-10 text-5xl font-heading text-center font-bold text-gray-500 ">
      ...
      <div id="carousal" className="w-[100%] my-10" >
