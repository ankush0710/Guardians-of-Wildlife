  ...
  return (
    <>
      <div id="container" className="md:flex md:justify-between">
        ...
        <div
          id="address_section"
          className="flex flex-col gap-10 mt-10 md:flex-1 md:ms-8"
        >  
          <h1 className="font-heading text-3xl font-bold text-center">Find Us</h1>
          <div
            id="card-1"
        ...
        <div id="contact-form" className="mt-10 md:flex-1">
          ...
          <div
            id="contact-form"
            className="bg-[#ECE7D1] rounded-xl flex flex-col pt-10 pb-15 px-10 mx-3 my-10 relative md:w-auto lg:w-2xl md:shadow-lg"
          >
            <form action="">
